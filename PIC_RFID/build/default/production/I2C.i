...
# 10 "D:\\Program Files\\Microchip\\xc8\\v2.36\\pic\\include\\c99\\stdio.h" 3
# 1 "D:\\Program Files\\Microchip\\xc8\\v2.36\\pic\\include\\c99\\features.h" 1 3
# 10 "D:\\Program Files\\Microchip\\xc8\\v2.36\\pic\\include\\c99\\stdio.h" 2 3
...
void I2CLCD_Init(uint32_t i2c_clk_freq)
{
  SSPCON1 = 0x28;
  SSPCON2 = 0x00;
  SSPADD = (27000000/(4 * i2c_clk_freq)) - 1;
  SSPSTAT = 0;
}
...
void LCD_Write_Nibble(uint8_t n)
{
  ...
  _delay((unsigned long)((1)*(27000000/4000000.0)));
  Expander_Write(n & 0xFB);
  _delay((unsigned long)((100)*(27000000/4000000.0)));
}
...
void LCD_Cmd(uint8_t Command)
{
  ...
  if((Command == 0x01) || (Command == 0x02))
    _delay((unsigned long)((2)*(27000000/4000.0)));
}
...
void LCD_Begin(uint8_t _i2c_addr)
{
  ...
  _delay((unsigned long)((40)*(27000000/4000.0)));
  LCD_Cmd(3);
  _delay((unsigned long)((5)*(27000000/4000.0)));
  LCD_Cmd(3);
  _delay((unsigned long)((5)*(27000000/4000.0)));
  LCD_Cmd(3);
  _delay((unsigned long)((5)*(27000000/4000.0)));
